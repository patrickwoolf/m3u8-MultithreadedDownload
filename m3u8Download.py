...
def getheaders():
    user_agent_list=[]
    f = open(os.path.abspath(os.path.dirname(__file__))+'/utils/user-agent-list.txt')  # 返回一个文件对象
...
def merge_file(path):
    ...
    elif "Linux" in plat_f:
        str1 = ""
        for s in checkDownloadFolder("./"):
            str1 += s + " "
...
if __name__ == "__main__":
    # merge_file("./Download/20210422_174811")
    theread=50 #默认线程数
    # document = "/home/patricia/Videos" #保存路径
    url = "" #下载地址
    ...
    # # url="https://www.chifenghualvlvxingshe.com/20190616/N8RenMGL/index.m3u8"
    #
